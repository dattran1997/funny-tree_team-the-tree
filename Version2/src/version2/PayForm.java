...
public class PayForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hôm nay bạn được nhận lương ?");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setText("vui lòng cộng thêm số dư");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
            fn.UpdateMoney1(NAMELOGIN, Integer.parseInt(input.getText()));
        }catch(Exception ex){
            System.out.println("update 10tr");
        }
